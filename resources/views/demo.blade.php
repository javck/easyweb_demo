			...
			@include('easyweb2::partials.modal_login')
				...
				<div id="section-gallery" class="page-section nopadding nomargin">
					...
					<div class="container topmargin bottommargin-lg center clearfix">
						...
						<h3 class="ls1 t400" style="font-size: 32px; margin-bottom: 10px;">{{ $item_gallery_top->title }}</h3>
						<p class="lead divcenter" style="max-width: 600px">{{ $item_gallery_top->subtitle }}</p>
						<a href="{{ $item_gallery_top->url }}" class="button button-circle capitalize">{{ $item_gallery_top->url_txt }}</a>
